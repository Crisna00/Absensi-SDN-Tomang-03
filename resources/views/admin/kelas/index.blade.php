                            ...
                            <div class="row g-3">
                                <div class="col-md-5">
                                    ...
                                    <select name="tingkat" class="form-select">
                                        ...
                                        <option value="1" {{ request('tingkat') == '1' ? 'selected' : '' }}>Kelas 1</option>
                                        <option value="2" {{ request('tingkat') == '2' ? 'selected' : '' }}>Kelas 2</option>
                                        <option value="3" {{ request('tingkat') == '3' ? 'selected' : '' }}>Kelas 3</option>
                                        <option value="4" {{ request('tingkat') == '4' ? 'selected' : '' }}>Kelas 4</option>
                                        <option value="5" {{ request('tingkat') == '5' ? 'selected' : '' }}>Kelas 5</option>
                                        <option value="6" {{ request('tingkat') == '6' ? 'selected' : '' }}>Kelas 6</option>
                                    </select>
                                </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        ...
                        <div class="d-flex gap-2 flex-wrap align-items-center">
                            <div class="btn-group" role="group">
                                ...
                                <a href="{{ route('admin.kelas.index', ['tingkat' => '1']) }}" 
                                   class="btn btn-sm {{ request('tingkat') == '10' ? 'btn-success' : 'btn-outline-success' }}">
                                    Kelas 1
                                </a>
                                <a href="{{ route('admin.kelas.index', ['tingkat' => '2']) }}" 
                                   class="btn btn-sm {{ request('tingkat') == '2' ? 'btn-info' : 'btn-outline-info' }}">
                                    Kelas 2
                                </a>
                                <a href="{{ route('admin.kelas.index', ['tingkat' => '3']) }}" 
                                   class="btn btn-sm {{ request('tingkat') == '3' ? 'btn-warning' : 'btn-outline-warning' }}">
                                    Kelas 3
                                </a>
                                 <a href="{{ route('admin.kelas.index', ['tingkat' => '4']) }}" 
                                   class="btn btn-sm {{ request('tingkat') == '4' ? 'btn-danger' : 'btn-outline-danger' }}">
                                    Kelas 4
                                </a>
                                 <a href="{{ route('admin.kelas.index', ['tingkat' => '5']) }}" 
                                   class="btn btn-sm {{ request('tingkat') == '5' ? 'btn-primary' : 'btn-outline-primary' }}">
                                    Kelas 5
                                </a>
                                 <a href="{{ route('admin.kelas.index', ['tingkat' => '6']) }}" 
                                   class="btn btn-sm {{ request('tingkat') == '6' ? 'btn-secondary' : 'btn-outline-secondary' }}">
                                    Kelas 6
                                </a>
