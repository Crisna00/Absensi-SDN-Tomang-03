                    ...
                    <form action="{{ route('admin.settings.school.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="text-center mb-4">
                            <div class="position-relative d-inline-block">
                                <img id="logoPreview" 
                                     src="{{ isset($setting) && $setting->logo_path ? $setting->logo_url : asset('admin_assets/images/brand/logo/Logo-sd.png') }}" 
                                     alt="Logo Sekolah" 
                        ...
                        <div class="mb-3">
                            <label for="school_name" class="form-label fw-semibold">
                                SDN 03 Tomang <span class="text-danger">*</span>
                            </label>
                            <input type="text" 
