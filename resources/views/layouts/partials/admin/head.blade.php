...
<!-- Favicon icon-->
<!-- Favicon icon-->
<link rel="shortcut icon" type="image/png" href="{{ asset('admin_assets/images/brand/logo/Logo-sd.png') }}">
<link rel="icon" type="image/png" href="{{ asset('admin_assets/images/brand/logo/Logo-sd.png') }}">
<!-- Libs CSS -->
